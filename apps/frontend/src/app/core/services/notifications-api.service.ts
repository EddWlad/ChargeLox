...
import { Notification, PaginationResponse } from '../models/domain.models';
...
export class NotificationsApiService {
  ...
  listMine(query: { leida?: boolean; page?: number; limit?: number }): Observable<PaginationResponse<Notification>> {
    return this.http.get<PaginationResponse<Notification>>(`${API_BASE_URL}/notifications/me`, {
